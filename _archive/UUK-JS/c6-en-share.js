...
C6.Share = {
    ...
    media: {
        'facebook': {
            ...
            'btnSelector': '.share_button.facebook_button',
        },
        'twitter': {
            'url': 'https://twitter.com/intent/tweet?text=',
            'msgSelector': '.social-share-tw',
            'btnSelector': '.share_button.twitter_button',
        },
        'whatsapp': {
            'url': 'whatsapp://send?text=',
            'msgSelector': '.social-share-wa',
            'btnSelector': '.share_button.whatsapp_button',
        },
        'email': {
            ...
            'btnSelector': '.share_button.email_button',
        }
    }
}        